...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:cce11="http://www.sat.gob.mx/ComercioExterior11" xmlns:donat="http://www.sat.gob.mx/donat" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:leyendasFisc="http://www.sat.gob.mx/leyendasFiscales" xmlns:pfic="http://www.sat.gob.mx/pfic" xmlns:tpe="http://www.sat.gob.mx/TuristaPasajeroExtranjero" xmlns:nomina12="http://www.sat.gob.mx/nomina12" xmlns:registrofiscal="http://www.sat.gob.mx/registrofiscal" xmlns:pagoenespecie="http://www.sat.gob.mx/pagoenespecie" xmlns:aerolineas="http://www.sat.gob.mx/aerolineas" xmlns:valesdedespensa="http://www.sat.gob.mx/valesdedespensa" xmlns:consumodecombustibles="http://www.sat.gob.mx/consumodecombustibles" xmlns:notariospublicos="http://www.sat.gob.mx/notariospublicos" xmlns:vehiculousado="http://www.sat.gob.mx/vehiculousado" xmlns:servicioparcial="http://www.sat.gob.mx/servicioparcialconstruccion" xmlns:decreto="http://www.sat.gob.mx/renovacionysustitucionvehiculos" xmlns:destruccion="http://www.sat.gob.mx/certificadodestruccion" xmlns:obrasarte="http://www.sat.gob.mx/arteantiguedades" xmlns:ine="http://www.sat.gob.mx/ine" xmlns:iedu="http://www.sat.gob.mx/iedu" xmlns:ventavehiculos="http://www.sat.gob.mx/ventavehiculos" xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:pago10="http://www.sat.gob.mx/Pagos">
  ...
  <xsl:include href="../fePlantillas/include33/ecc11.xslt"/> 
  <xsl:include href="../fePlantillas/include33/donat11.xslt"/>
  <xsl:include href="../fePlantillas/include33/divisas.xslt"/>
  <xsl:include href="../fePlantillas/include33/implocal.xslt"/>
  <xsl:include href="../fePlantillas/include33/leyendasFisc.xslt"/>
  <xsl:include href="../fePlantillas/include33/pfic.xslt"/>
  <xsl:include href="../fePlantillas/include33/TuristaPasajeroExtranjero.xslt"/>
  <xsl:include href="../fePlantillas/include33/nomina12.xslt"/>
  <xsl:include href="../fePlantillas/include33/cfdiregistrofiscal.xslt"/>
  <xsl:include href="../fePlantillas/include33/pagoenespecie.xslt"/>
  <xsl:include href="../fePlantillas/include33/aerolineas.xslt"/>
  <xsl:include href="../fePlantillas/include33/valesdedespensa.xslt"/>
  <xsl:include href="../fePlantillas/include33/consumodecombustibles.xslt"/>
  <xsl:include href="../fePlantillas/include33/notariospublicos.xslt"/>
  <xsl:include href="../fePlantillas/include33/vehiculousado.xslt"/>
  <xsl:include href="../fePlantillas/include33/servicioparcialconstruccion.xslt"/>
  <xsl:include href="../fePlantillas/include33/renovacionysustitucionvehiculos.xslt"/>
  <xsl:include href="../fePlantillas/include33/certificadodedestruccion.xslt"/>
  <xsl:include href="../fePlantillas/include33/obrasarteantiguedades.xslt"/>
  <xsl:include href="../fePlantillas/include33/ComercioExterior11.xslt"/>
  <xsl:include href="../fePlantillas/include33/ine11.xslt"/>
  <xsl:include href="../fePlantillas/include33/iedu.xslt"/>
  <xsl:include href="../fePlantillas/include33/ventavehiculos11.xslt"/>
  <xsl:include href="../fePlantillas/include33/terceros11.xslt"/>
  <xsl:include href="../fePlantillas/include33/Pagos10.xslt"/>
